...
![](004_visualisasi_files/figure-markdown_github/unnamed-chunk-3-1.png)
...
![](004_visualisasi_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
![](004_visualisasi_files/figure-markdown_github/unnamed-chunk-5-1.png)
...
![](004_visualisasi_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](004_visualisasi_files/figure-markdown_github/unnamed-chunk-7-1.png)
...
ggplot(data = evals, aes(x = age, y = score)) +
  geom_jitter() +
  geom_smooth(method = "lm") #atau metode gom/loess
```

![](004_visualisasi_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
ggplot(data = evals, aes(x = age, y = score, colour = ethnicity)) +
  geom_jitter() +
  scale_colour_manual(values = c("minority" = "gold", "not minority" = "purple")) +
  geom_smooth(method = "lm") +
  labs(
    x = "Usia",
    y = "Skor",
    title = "Grafik antara skor terhadap usia",
    subtitle = "Subtitle",
    caption = "Sumber data:...",
    colour = "Etnik"
  )
...
![](004_visualisasi_files/figure-markdown_github/unnamed-chunk-9-1.png)
